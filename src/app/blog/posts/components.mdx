...
<CodeBlock
    ...
    <Row fillWidth horizontal="center">
      <Card
        ...
        gap="8"
      >
        <Media src="/images/projects/nvpilot/hero.png" aspectRatio="16/9" radius="l" sizes="400px" />
...
<CodeBlock
    ...
    topRadius="l"
    codeHeight={24}
    preview={<Media src="/images/projects/nvpilot/hero.png" alt="Example image" sizes="640px" aspectRatio="16/9" radius="l" />}
    codes={[
      {
        code:
`<Media
    src="/images/projects/nvpilot/hero.png"
    sizes="640px"
    alt="Example image"
    aspectRatio="16/9"
    radius="l"
