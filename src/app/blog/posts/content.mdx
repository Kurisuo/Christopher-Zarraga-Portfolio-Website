...
Replace the `public/images/christobal.jpg` file with your own avatar image. It is used on the `/about` page as well as on the dynamically generated `open-graph` images.
