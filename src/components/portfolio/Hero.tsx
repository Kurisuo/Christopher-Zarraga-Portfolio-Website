      ...
      <div className="mt-10 grid items-start gap-4 sm:grid-cols-2 lg:mt-12">
        ...
        <Reveal delay={260}>
          ...
          >
            ...
            <ul className="mt-2 space-y-0.5 font-display text-base font-semibold leading-snug">
            ...
            <div className="mt-3 grid grid-cols-[minmax(0,0.85fr)_minmax(0,1.15fr)] items-center gap-2 pt-1">
              <ChessQueen />
              <div className="flex max-h-40 w-full items-center justify-center overflow-hidden rounded-[1px] bg-volt-foreground/10">
                <img
                  src={lichessGame.url}
