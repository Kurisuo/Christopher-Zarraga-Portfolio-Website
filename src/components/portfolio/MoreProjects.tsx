...
const projects = [
  ...
  },
  {
    ...
    metric: "4 goal-tracking components",
  },
  {
    tag: "C++17 / PyTorch",
  ...
  },
  {
    ...
    metric: "0.36ms p50 · 250k vectors · 33k chunks/sec",
  ...
  },
  {
    ...
    metric: "~550ms perception · ~3s rollback",
  ...
  },
  {
    ...
    metric: "~8,400 req/s · 2.2× single-threaded",
...
export function MoreProjects() {
  ...
  return (
    <section id="work" className="portfolio-section snap-start scroll-mt-[120px] py-14 lg:py-20">
      <Reveal>
